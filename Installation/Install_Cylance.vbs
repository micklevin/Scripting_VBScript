...
Const sProductName       = "Cylance PROTECT"
Const sProductVersion    = "2.0.1430.18"
' A registry path to either 64 or 32 bit branch to search for software installation data
Const sKeyUninstall      = "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall"                 ' x86
'                        = "SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall"     ' x64

' UNC path to the Installer. Make sure it's well-distributed among site where clients who need it reside.
Const sInstallPath       = "\\domain.local\DFS\IT\Applications\Cylance"

' MSI version

Const sInstallMsi_x64    = "CylanceProtect_x64_2.0.1430.msi"
Const sInstallMsi_x86    = "CylanceProtect_x86_2.0.1430.msi"
Const sTransformMsi_x64  = "COMPANY_x64.mst"
Const sTransformMsi_x86  = "COMPANY_x86.mst"

' Exe version

Const sInstallExe_x64    = ""
Const sInstallExe_x86    = ""

' Additional parameters

Const sInstallParams_x64 = "/qn"
Const sInstallParams_x86 = "/qn"
